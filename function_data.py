question_dict = [
    {
        ...
        "question_nbr": 0,
        "answers": {
            1: "1 - Documents not making it into Millennium/Missing documents.",
            2: "2 - Cold feed documents aren't processing.",
            3: "3 - Cold feed documents failing to cer_batchindex.",
            4: "4 - Duplicate cold feed documents in Millennium.",
        ...
        "additional_text": {
            1: """If the document never made it to Millennium, or missing from the patient's chart, we need to start 
                investigating at the beginning of the cold feed process.""",
            2: """If the document aren't processing through the cold feed process, we need to start investigating 
                at the beginning of the cold feed process.""",
            3: """If the documents are in cer_batchindex:
            ...
            4: """Duplicate documents is usually an issue with Batch Indexing Service and not AXRM or Batch Prep. 
                        ...
                        * Once you have found the server, 
                            ...
                            - If there two indexing services pointing to the same AUTO queue
                                * Contact CWx and let them know that this isn't allowed and they need to turn on off or 
                                  ...
                                  queue.""",
            5: None,
            0: "You are exiting this program"
        }
    },
    {
        ...
        "additional_text": {
            1: "",
            2: "Get the file share directory from the client and then re-run the program",
            0: "You are exiting the application."
        }
    },
    {
        "question": """You need to figure out which application (Batch Prep or AXRM) is processing these documents.
        ...
        "question_nbr": 2,
        "answers": {
            1: "1. There are files in the directory ending in .error or .parse.",
            2: "2. There are files in the directory ending in .failedpdf or .cxpdf.",
            3: "3. There are no files in the directory.",
            0: "0 - Exit Application"
        },
        "next_question": {
            0: False,
        ...
        "next_function": {
            0: None,
            1: "batch_prep_filename_values",
            2: "axrm_file_extension",
            3: None
        },
        "additional_text": {
            1: """This is a batch prep issue. 
            ...
            2: """This means the document were processed by AXRM.
            ...
            3: """If there are no files in the directory 
            ...
            0: "You are now exiting the application."
        }
    },
    {
        "question": """Select the number that applies:""",
        "question_nbr": 3,
        "answers": [
        ...
        "additional_text": {
            1: """If you see .error files, that means Batch Prep failed these documents. 
            ...
            2: """If you only see .parse files inside the directory, this means that Batch prep processed these documents 
            ...
            3: """If you see .error files, that means Batch Prep failed these documents. 
    ...
    },
    {
        ...
        "question_nbr": 4,
        "answers": {
            1: "1 - The client provided a filename",
            2: "2 - The client provided a patient example",
            3: "3 - The client provided the date that the files were sent",
            0: "0 - Exit Application"
        },
        "next_question": {
            0: False,
        ...
        "additional_text": {
            1: """If the client provided the filename, we can start looking for it in Millennium. 
                    - Step 1:
            ...
            2: """If the user provided a patient that the cold feed document isn't on the patient's chart, there a couple 
            ...
            3: """If you have a date range, you can try to find the document using the date range and batch name
                - Go to a Citrix server
                        - Open discernvisualdeveloper
    ...
    },
    {
        ...
        "additional_text": {
            1: """.CXPDF means that the files were processed successfully by AXRM. 
    ...
    {
        "question": """On the ermx server and open AXRM (ApplicationXtenderReportsMgmtAdmin) 
            ...
            Do you see the error logs for the documents that failed?""",
        "question_nbr": 6,
        "answers": {
            1: "1 - True",
            2: "2 - False",
        ...
        "additional_text": {
            1: """In the report logs, open one of the failed logs to see the error.
            ...
            2: """AXRM removes the logs from the application after a few days, but leaves the logs in the 
    ...
    },
    {
        ...
        "question_nbr": 7,
        "answers": {
            1: "1 - AUTO queue (legacy architecture)",
            2: "2 - MAN queue (legacy or single app architecture)",
            3: "3 - AUTO queue (single app architecture)",
            4: "4 - Documents processed successfully",
            0: "0 - Exit Application"
        },
        "next_question": {
            0: False,
        ...
        "additional_text": {
            1: """If the documents aren't processing through, or stuck in the AUTO queue (legacy), there are a couple 
                things to check. 
                    * Note: 
                    ...
                    2. There are a couple of defects with the old legacy architecture.
                        ...
                        iii. Auto-versioning fails if the incoming document doesn't have a blob handle and blob_uid 
                             is required in CEROTG
                                - https://jira2.cerner.com/browse/DOCIMAGING-10892""",
            2: """If the documents are in the MAN queue (legacy or single app):
                    - This means that the batch indexing service failed this document during processing. 
                          ...
                          the documents were processed successfully.
                            ...
                            - If you see that it was processed to the patient's chart (usually you can tell on the trans log
                              table because it will have an action type flag of 0 (submitted) or 5 (document capture)): 
                                ...
                                * Once you have the encounter number or person name, you should be able to find the patient
                                  in PowerChart and look for the document.""",
            3: """If the documents are in the AUTO (single app architecture), there are a few things to check.
                    1. Check to see if the batch indexing service is on.
                            - Go look for the batch indexing service pointing to this queue.
                            - You can find the batch indexing services two ways.
                                i. Look through the servers they might be running on, which are the:
            ...
            4: """The documents made it through the whole process and should be on the patient's chart.
